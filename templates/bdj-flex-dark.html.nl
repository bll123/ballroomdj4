      ...
      <div id="controlspage1" class="dispbox">
          ...
          <div class="rightbox vcenter">
            ...
            <div class="divshown" id="pausestatusd">
              <img class="mpad mpadr" id="pausestatusi"
                  src="mrc/dark/pause.svg" alt="pause">
            </div>
          </div>
        </div>
        <div class="linebox">
          <input class="stretch grow wb" type="submit" id="fadeb"
          ...
          <div class="rightbox vcenter">
            <div class="divshown" id="repeatstatusd">
              <img class="mpad mpadr" id="repeatstatusi"
                  src="mrc/dark/repeat.svg" alt="repeat">
            </div>
          </div>
        </div>
        <div class="linebox">
        ...
        <div class="linebox">
          ...
          <div class="flexjend rightbox vcenter">
            <p class="mpad tright" id="speedd">100%</p>
          </div>
        </div>
        <div class="linebox">
      ...
      <div id="controlspage2" class="divnone">
        ...
        <div class="linebox">
          <input class="stretch grow wb" type="submit"
              ...
              name="queue" value="Wachtrij" msgstr "" msgstr "" msgstr "Wachtrij B" msgstr "" msgstr "Wachtrij lengte">
        </div>
        <div class="linebox">
          <input class="stretch grow wb" type="submit"
        ...
        <div class="linebox">
          ...
          <input class="stretch grow wb" type="submit"
            ...
            name="plqueue" value="Wachtrij" msgstr "" msgstr "" msgstr "Wachtrij B" msgstr "" msgstr "Wachtrij lengte">
        </div>
    </div>
  </div>
...
bdj.chgMute = function () {
  ...
  if (bdj.muteState == 0) {
    ob.src = 'mrc/dark/mute.svg';
  } else {
    ob.src = 'mrc/dark/unmute.svg';
  }
  bdj.sendCmd ('volmute');
}
...
bdj.updateData = function (data) {
  ...
  o.src = 'mrc/dark/'+jd.playstate+".svg";
