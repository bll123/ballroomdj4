...
<body>
  <div class="mainbox">
      ...
      <div id="controlspage1" class="dispbox">
        ...
        <div class="linebox">
          <p class="pbold vcenter stretch grow padlr" id="dance"></p>
        </div>
        <div class="linebox">
          <p class="pbold vcenter stretch grow padlr" id="artist"></p>
        </div>
        <div class="linebox">
          <p class="pbold vcenter stretch grow padlr" id="title"></p>
        </div>
      </div>
