...
enum {
  ...
  BDJ4_INIT_NO_LOCK             = 0x0040,
  BDJ4_INIT_WAIT                = 0x0080,
  BDJ4_DB_REBUILD               = 0x0100,
  BDJ4_DB_CHECK_NEW             = 0x0200,
  BDJ4_DB_PROGRESS              = 0x0400,
  BDJ4_DB_REORG                 = 0x0800,
  BDJ4_DB_UPD_FROM_TAGS         = 0x1000,
  BDJ4_DB_WRITE_TAGS            = 0x2000,
  BDJ4_CLI                      = 0x4000,
};
