...
typedef struct {
  ...
  void              (*pliiStartPlayback) (plidata_t *, ssize_t dpos);
  ...
  double            (*pliiRate) (plidata_t *pliData, double drate);
...
void          pliiStartPlayback (plidata_t *pliData, ssize_t dpos);
